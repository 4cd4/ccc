...
![VaultMind](https://raw.githubusercontent.com/4cd4/ccc/master/images/wordmark.png)

[VaultMind](https://github.com/4cd4/ccc)
...
```
helm install my-vaultmind ./vaultmind -f values-secret.yaml
```
