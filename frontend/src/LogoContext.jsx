...
import VaultMindLogo from "./media/logo/vaultmind.svg";
import VaultMindLogoDark from "./media/logo/vaultmind-dark.svg";
  ...
  async function fetchInstanceLogo() {
    ...
    try {
      ...
      if (logoURL) {
        ...
        isLightMode() ? setLogo(VaultMindLogoDark) : setLogo(VaultMindLogo);
