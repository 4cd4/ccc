            ...
            <form onSubmit={acceptTos}>
              <div className="py-7 px-9 space-y-4 flex-col">
                <div className="w-full text-white text-md flex flex-col gap-y-4">
                  <p>
                    Experimental features of VaultMind are features that we
                  ...
                  <div>
                    ...
                    <ul className="list-disc ml-6 text-sm font-mono mt-2">
                      ...
                      <li>Potential bugs or issues using VaultMind.</li>
                    </ul>
                  </div>
                  ...
                  <div>
                    ...
                    <ul className="list-disc ml-6 text-sm font-mono mt-2">
                      ...
                      <li>
                        ...
                        configurations, or subscriptions of VaultMind.
                      </li>
                      <li>
                  ...
                  <p>
                    ...
                    <a
                      href="https://github.com/4cd4/ccc/wiki/experimental-features"
                      className="underline text-blue-500"
                    >
                      VaultMind documentation
                    </a>{" "}
                    or email{" "}
                    <a
                      href="mailto:support@vaultmind.app"
                      className="underline text-blue-500"
                    >
