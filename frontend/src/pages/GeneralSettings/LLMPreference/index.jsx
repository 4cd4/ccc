...
import VaultMindIcon from "@/media/logo/vaultmind-icon.svg"; // Using existing icon file
...
// VaultMind: Only local/privacy-friendly LLM providers shown in settings.
// Cloud providers are removed to enforce local-first privacy.
              ...
              <div className="relative">
                ...
                {searchMenuOpen ? (
                  ...
                  >
                    <div className="flex gap-x-4 items-center">
                      <img
                        src={selectedLLMObject?.logo || VaultMindIcon}
