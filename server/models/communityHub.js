...
/**
 * An interface to the VaultMind Community Hub external API.
 */
const CommunityHub = {
   ...
   * so we can unzip and import them to the VaultMind instance.
  ...
  /**
   * Apply an item to the VaultMind instance. Used for simple items like slash commands and system prompts.
  ...
  /**
   * Import a bundle item to the VaultMind instance by downloading the zip file and importing it.
